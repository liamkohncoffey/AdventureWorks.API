...
namespace AdventureWorks.Client
{
    public partial class AdventureWorksContext : DbContext
    {
        ...
        public AdventureWorksContext(IConfiguration configuration)
        {
            _connectionString = configuration.GetSection("ConnectionString").Get<ConnectionStringSetting>();
        }
        ...
        public virtual DbSet<SpaceUsed> SpaceUsed { get; set; }
        ...
        public virtual DbSet<TransactionIndex3361bea13395484bB874Ed645c3394b2> TransactionIndex3361bea13395484bB874Ed645c3394b2 { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(_connectionString.AdventureWorksDbContext);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SpaceUsed>(entity =>
            {
                entity.HasNoKey();
                ...
                entity.Property(e => e.TableData).HasMaxLength(200);

                entity.Property(e => e.TableName).HasMaxLength(200);

                entity.Property(e => e.TotalRows).HasMaxLength(200);

                entity.Property(e => e.Unused).HasMaxLength(200);
            });
            ...
            modelBuilder.Entity<TransactionIndex3361bea13395484bB874Ed645c3394b2>(entity =>
            {
                entity.ToTable("_TransactionIndex_3361bea1-3395-484b-b874-ed645c3394b2");
